...
pub fn main_1_7_1() {
    ...
    let (ourShader, VBO, VAO, texture1, texture2, cubePositions) = unsafe {
        ...
        // ------------------------------------
        let ourShader = Shader::new("src/_1_getting_started/shaders/7.1.camera.vs", "src/_1_getting_started/shaders/7.1.camera.fs"); // you can name your shader files however you like)
    ...
    while !window.should_close() {
        ...
        unsafe {
            ...
            let view: Matrix4<f32> =
                Matrix4::look_at(Point3::new(camX, 0.0, camZ), Point3::new(0.0, 0.0, 0.0), Vector3::new(0.0, 1.0, 0.0));
